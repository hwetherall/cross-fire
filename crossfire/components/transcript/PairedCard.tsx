    ...
    <div className="rounded-lg border border-gray-200 bg-white overflow-hidden">
      ...
      <div className="p-4">
        <div className="flex items-center gap-2 mb-3">
          <span className="text-[11px] font-mono text-gray-400">{objection.id}</span>
          <CategoryBadge category={objection.category} />
          <SeverityDot severity={objection.severity} />
          <span className="text-[11px] text-gray-400">{objection.severity}</span>
        </div>

        <div className="border-l-2 border-orange-300 pl-3 mb-3">
      ...
      {response ? (
        <div className="p-4">
          <div className="flex items-center gap-2 mb-3">
            <span className="text-[11px] font-medium text-gray-500">Blue</span>
